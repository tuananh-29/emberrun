...
# ══════════════════════════════
#  THAN / CỦI – PICKUP ITEM
#  Setup trong Editor:
#  1. Tạo scene Coal.tscn → root node = Area2D
#  2. Thêm con: CollisionShape2D (CircleShape2D r=8)
#  3. Thêm con: AnimatedSprite2D hoặc Sprite2D
#  4. Attach script này vào node Area2D
#  5. Kéo Coal.tscn vào scene Game, đặt đúng vị trí
# ══════════════════════════════
...
@onready var sprite = $AnimatedSprite2D   # hoặc $Sprite2D nếu dùng Sprite2D
